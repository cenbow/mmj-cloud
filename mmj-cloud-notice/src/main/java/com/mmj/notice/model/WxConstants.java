...
public class WxConstants {
     ...
     * 获取已关注的用户信息
     */
    public static String URL_GET_USERINFO= "https://api.weixin.qq.com/cgi-bin/user/info";
     ...
     * 发送模板消息
     */
    public static String URL_MSG_TEMPLATE_MIN = "https://api.weixin.qq.com/cgi-bin/message/wxopen/template/send";

    /**
     * 生成受限的小程序二维码 可接受的参数较长
     */
    public static String URL_QRCODE_MIN = "https://api.weixin.qq.com/wxa/getwxacode";

    /**
     * 生成公众号二维码
     */
    public static String URL_QRCODE_MP = "https://api.weixin.qq.com/cgi-bin/qrcode/create";

    /**
     * 公众号根据ticket获取二维码
     */
    public static String URL_QRCODE_SHOW_MP = "https://mp.weixin.qq.com/cgi-bin/showqrcode";

    /**短信发送地址**/
    public static String smsMsg = "http://api.91jianmi.com/sdk/SMS";
}
