 ...
 * @date: 2019/6/19
 */
@JobHandler(value = "DecActiveVirtual2Handler")
@Component
@Slf4j
public class DecActiveVirtual2Handler extends IJobHandler {
    @Autowired
    ...
    public ReturnT<String> execute(String s) throws Exception {
        try {
            ReturnData returnData = activeFeignClient.decActiveVirtual2();
            ...
            log.error("减少虚拟库存2错误 {}", e.getMessage());
            return FAIL;
        }
    }
}
