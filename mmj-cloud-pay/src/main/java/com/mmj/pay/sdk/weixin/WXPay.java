...
public class WXPay {
    ...
    public Map<String, String> fillRequestData(Map<String, String> reqData) throws Exception {
        if(StringUtils.isEmpty(reqData.get("mchid"))){
    ...
    public Map<String, String> transfers(Map<String, String> reqData, int connectTimeoutMs, int readTimeoutMs) throws Exception {
        String url = WXPayConstants.TRANSFERS_URL_SUFFIX;
        Map<String, String> map = this.fillRequestData(reqData);
        map.remove("sign_type");
        String respXml = this.requestWithCert(url, map, connectTimeoutMs, readTimeoutMs);
