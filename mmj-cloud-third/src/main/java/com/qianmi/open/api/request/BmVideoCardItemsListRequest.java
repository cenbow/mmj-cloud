...
import com.qianmi.open.api.response.BmVideoCardItemsListResponse;
 ...
 * @since 1.0
 */
public class BmVideoCardItemsListRequest implements QianmiRequest<BmVideoCardItemsListResponse> {
	...
	public Class<BmVideoCardItemsListResponse> getResponseClass() {
		return BmVideoCardItemsListResponse.class;
	}
