...
import com.qianmi.open.api.response.RechargeBaseItemListResponse;
 ...
 * @since 1.0
 */
public class RechargeBaseItemListRequest implements QianmiRequest<RechargeBaseItemListResponse> {
	...
	public Class<RechargeBaseItemListResponse> getResponseClass() {
		return RechargeBaseItemListResponse.class;
	}
