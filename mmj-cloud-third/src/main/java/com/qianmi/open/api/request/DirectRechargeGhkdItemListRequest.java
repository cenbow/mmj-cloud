 ...
 * @since 1.0
 */
public class DirectRechargeGhkdItemListRequest implements QianmiRequest<DirectRechargeGhkdItemListResponse> {
	...
	public Class<DirectRechargeGhkdItemListResponse> getResponseClass() {
		return DirectRechargeGhkdItemListResponse.class;
	}
