...
import com.qianmi.open.api.response.DirectRechargeGhkdGetPhoneInfoResponse;
 ...
 * @since 1.0
 */
public class DirectRechargeGhkdGetPhoneInfoRequest implements QianmiRequest<DirectRechargeGhkdGetPhoneInfoResponse> {
	...
	public Class<DirectRechargeGhkdGetPhoneInfoResponse> getResponseClass() {
		return DirectRechargeGhkdGetPhoneInfoResponse.class;
	}
