...
public class RequestCheckUtils {
	...
	public static void checkMinLength(String value,int minLength,String fieldName)throws ApiRuleException{
		if(value!=null){
	...
	public static void checkLength(String value,int length,String fieldName)throws ApiRuleException{
		if(value!=null){
			if(value.length()!=length){
				throw new ApiRuleException(ERROR_CODE_ARGUMENTS_INVALID,"client-error:Invalid Arguments:the length of "+fieldName+" must be "+length+".");
			}
		}
	}
