...
import com.qianmi.open.api.response.BmRechargeOrderListResponse;
 ...
 * @since 1.0
 */
public class BmRechargeOrderListRequest implements QianmiRequest<BmRechargeOrderListResponse> {
	...
	public Class<BmRechargeOrderListResponse> getResponseClass() {
		return BmRechargeOrderListResponse.class;
	}
