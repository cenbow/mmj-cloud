...
import com.qianmi.open.api.response.TrainOrdersListResponse;
 ...
 * @since 1.0
 */
public class TrainOrdersListRequest implements QianmiRequest<TrainOrdersListResponse> {
	...
	public Class<TrainOrdersListResponse> getResponseClass() {
		return TrainOrdersListResponse.class;
	}
