...
import com.qianmi.open.api.response.VideoCardItemsListResponse;
 ...
 * @since 1.0
 */
public class VideoCardItemsListRequest implements QianmiRequest<VideoCardItemsListResponse> {
	...
	public Class<VideoCardItemsListResponse> getResponseClass() {
		return VideoCardItemsListResponse.class;
	}
