 ...
 * @since 1.0
 */
public class CardPasswordItemListRequest implements QianmiRequest<CardPasswordItemListResponse> {
	...
	public Class<CardPasswordItemListResponse> getResponseClass() {
		return CardPasswordItemListResponse.class;
	}
