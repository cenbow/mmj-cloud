 ...
 * @since 1.0
 */
public class DirectRechargeWaterCoalItemListRequest implements QianmiRequest<DirectRechargeWaterCoalItemListResponse> {
	...
	public Class<DirectRechargeWaterCoalItemListResponse> getResponseClass() {
		return DirectRechargeWaterCoalItemListResponse.class;
	}
