 ...
 * @since 1.0
 */
public class MobileFlowCreateBillRequest implements QianmiRequest<MobileFlowCreateBillResponse> {
	...
	public Class<MobileFlowCreateBillResponse> getResponseClass() {
		return MobileFlowCreateBillResponse.class;
	}
