 ...
 * @since 1.0
 */
public class GasCardCreateBillRequest implements QianmiRequest<GasCardCreateBillResponse> {
	...
	public Class<GasCardCreateBillResponse> getResponseClass() {
		return GasCardCreateBillResponse.class;
	}
