 ...
 * @since 1.0
 */
public class TrafficFineCreateBillRequest implements QianmiRequest<TrafficFineCreateBillResponse> {
	...
	public Class<TrafficFineCreateBillResponse> getResponseClass() {
		return TrafficFineCreateBillResponse.class;
	}
