 ...
 * @since 1.0
 */
public class BmDirectRechargeGhkdItemListRequest implements QianmiRequest<BmDirectRechargeGhkdItemListResponse> {
	...
	public Class<BmDirectRechargeGhkdItemListResponse> getResponseClass() {
		return BmDirectRechargeGhkdItemListResponse.class;
	}
