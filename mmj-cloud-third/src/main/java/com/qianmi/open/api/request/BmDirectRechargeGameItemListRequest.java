...
import com.qianmi.open.api.response.BmDirectRechargeGameItemListResponse;
 ...
 * @since 1.0
 */
public class BmDirectRechargeGameItemListRequest implements QianmiRequest<BmDirectRechargeGameItemListResponse> {
	...
	public Class<BmDirectRechargeGameItemListResponse> getResponseClass() {
		return BmDirectRechargeGameItemListResponse.class;
	}
