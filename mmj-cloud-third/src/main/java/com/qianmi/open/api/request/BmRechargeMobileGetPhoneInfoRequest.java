 ...
 * @since 1.0
 */
public class BmRechargeMobileGetPhoneInfoRequest implements QianmiRequest<BmRechargeMobileGetPhoneInfoResponse> {
	...
	public Class<BmRechargeMobileGetPhoneInfoResponse> getResponseClass() {
		return BmRechargeMobileGetPhoneInfoResponse.class;
	}
