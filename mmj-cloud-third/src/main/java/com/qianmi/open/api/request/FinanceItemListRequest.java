...
import com.qianmi.open.api.response.FinanceItemListResponse;
 ...
 * @since 1.0
 */
public class FinanceItemListRequest implements QianmiRequest<FinanceItemListResponse> {
	...
	public Class<FinanceItemListResponse> getResponseClass() {
		return FinanceItemListResponse.class;
	}
