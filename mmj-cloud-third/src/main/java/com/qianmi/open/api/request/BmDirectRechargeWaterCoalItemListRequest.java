 ...
 * @since 1.0
 */
public class BmDirectRechargeWaterCoalItemListRequest implements QianmiRequest<BmDirectRechargeWaterCoalItemListResponse> {
	...
	public Class<BmDirectRechargeWaterCoalItemListResponse> getResponseClass() {
		return BmDirectRechargeWaterCoalItemListResponse.class;
	}
