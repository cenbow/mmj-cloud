...
import com.qianmi.open.api.response.BmTrafficFineItemListResponse;
 ...
 * @since 1.0
 */
public class BmTrafficFineItemListRequest implements QianmiRequest<BmTrafficFineItemListResponse> {
	...
	public Class<BmTrafficFineItemListResponse> getResponseClass() {
		return BmTrafficFineItemListResponse.class;
	}
