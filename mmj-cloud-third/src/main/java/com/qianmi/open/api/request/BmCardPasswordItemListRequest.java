...
import com.qianmi.open.api.response.BmCardPasswordItemListResponse;
 ...
 * @since 1.0
 */
public class BmCardPasswordItemListRequest implements QianmiRequest<BmCardPasswordItemListResponse> {
	...
	public Class<BmCardPasswordItemListResponse> getResponseClass() {
		return BmCardPasswordItemListResponse.class;
	}
