 ...
 * @since 1.0
 */
public class BmDirectRechargeWaterCoalGetAccountInfoRequest implements QianmiRequest<BmDirectRechargeWaterCoalGetAccountInfoResponse> {
	...
	public Class<BmDirectRechargeWaterCoalGetAccountInfoResponse> getResponseClass() {
		return BmDirectRechargeWaterCoalGetAccountInfoResponse.class;
	}
