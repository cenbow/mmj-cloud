 ...
 * @since 1.0
 */
public class BmDirectRechargeGhkdPayBillRequest implements QianmiRequest<BmDirectRechargeGhkdPayBillResponse> {
	...
	public Class<BmDirectRechargeGhkdPayBillResponse> getResponseClass() {
		return BmDirectRechargeGhkdPayBillResponse.class;
	}
