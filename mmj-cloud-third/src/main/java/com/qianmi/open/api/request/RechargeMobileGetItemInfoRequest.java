 ...
 * @since 1.0
 */
public class RechargeMobileGetItemInfoRequest implements QianmiRequest<RechargeMobileGetItemInfoResponse> {
	...
	public Class<RechargeMobileGetItemInfoResponse> getResponseClass() {
		return RechargeMobileGetItemInfoResponse.class;
	}
