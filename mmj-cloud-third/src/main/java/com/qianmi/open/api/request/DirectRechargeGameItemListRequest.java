...
import com.qianmi.open.api.response.DirectRechargeGameItemListResponse;
 ...
 * @since 1.0
 */
public class DirectRechargeGameItemListRequest implements QianmiRequest<DirectRechargeGameItemListResponse> {
	...
	public Class<DirectRechargeGameItemListResponse> getResponseClass() {
		return DirectRechargeGameItemListResponse.class;
	}
