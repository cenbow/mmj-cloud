 ...
 * @since 1.0
 */
public class GasCardItemListRequest implements QianmiRequest<GasCardItemListResponse> {
	...
	public Class<GasCardItemListResponse> getResponseClass() {
		return GasCardItemListResponse.class;
	}
