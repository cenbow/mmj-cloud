 ...
 * @since 1.0
 */
public class CoachOrderPayRequest implements QianmiRequest<CoachOrderPayResponse> {
	...
	public Class<CoachOrderPayResponse> getResponseClass() {
		return CoachOrderPayResponse.class;
	}
