...
import com.qianmi.open.api.response.BmGasCardItemListResponse;
 ...
 * @since 1.0
 */
public class BmGasCardItemListRequest implements QianmiRequest<BmGasCardItemListResponse> {
	...
	public Class<BmGasCardItemListResponse> getResponseClass() {
		return BmGasCardItemListResponse.class;
	}
