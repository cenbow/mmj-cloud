...
public interface ActiveGoodsConstants {
    ...
    //活动订单 + orderNo
    String ACTIVE_ORDER = "ACTIVE:SECKILL:ORDER:";  //set + orderNo
    String ACTIVE_ORDER_SKU = "ACTIVE:SECKILL:ORDER:SKU:";  //hash + sku
    ...
    interface LimitType {
        //每人每天
        String GOOD_LIMIT_RT ="GOOD_LIMIT_RT:";

        //每人限购数量
        String GOOD_LIMIT_R = "GOOD_LIMIT_R:";

        //限购数量
        String GOOD_LIMIT_TOTAL = "GOOD_LIMIT_TOTAL:";

        //款式限定
        String GOOD_LIMIT_GOODID = "GOOD_LIMIT_GOODID:";
    }
