...
public class WebMaketingVo {
    ...
    public WebMaketingVo() {
    }

    public WebMaketingVo(String classCode, String moduleType, String moduleName, String newCode, String oldCode, String menberCode) {
