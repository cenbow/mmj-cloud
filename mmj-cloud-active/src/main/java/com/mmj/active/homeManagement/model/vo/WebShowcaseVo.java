...
public class WebShowcaseVo {
    ...
    public WebShowcaseVo() {
    }

    public WebShowcaseVo(String classCode, String moduleType, String moduleName, String newCode, String oldCode, String menberCode) {
